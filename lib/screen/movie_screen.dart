                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                     ...
                     onPressed: () {
                        // 1. Tentukan pesan dan warna berdasarkan status SEBELUM di-toggle
                        // Jika sekarang isfav true, berarti setelah diklik akan jadi false (dihapus)
                        // Jika sekarang isfav false, berarti setelah diklik akan jadi true (ditambah)
                        String message = movie.isfav ? "Berhasil dihapus dari bookmark" : "Berhasil ditambahkan!";
                        Color color = movie.isfav ? Colors.red : Colors.green;

                        // 2. Bersihkan SnackBar lama agar tidak antre
                        ...
                        // 4. Baru panggil fungsi untuk mengubah data
                        onToggleFav(movie);
                      },
                    ),
                  ],
